...
// MMark implements a layer of middleware that serves
// markdown as HTML.
type MMark struct {
	// Server root
	Root string
...
func (md MMark) IsIndexFile(file string) bool {
...
func (md MMark) ServeHTTP(w http.ResponseWriter, r *http.Request) (int, error) {
