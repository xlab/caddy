...
// must be set).
func GenerateStatic(md MMark, cfg *Config) error {
...
func generateLinks(md MMark, cfg *Config) (bool, error) {
	generator.Lock()
...
func generateStaticHTML(md MMark, cfg *Config) error {
...
func computeDirHash(md MMark, c *Config) (string, error) {
