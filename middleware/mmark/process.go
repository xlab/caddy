...
func (md MMark) Process(c *Config, requestPath string, b []byte, ctx middleware.Context) ([]byte, error) {
	...
	buf := mmark.Parse(markdown, c.Renderer, extns)

	// set it as body for template
	metadata.Variables["body"] = buf.String()
...
func (md MMark) processTemplate(c *Config, requestPath string, tmpl []byte, metadata Metadata, ctx middleware.Context) ([]byte, error) {
...
func (md MMark) generatePage(c *Config, requestPath string, content []byte) error {
